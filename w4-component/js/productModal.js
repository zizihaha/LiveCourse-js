            ...
            <div class="row">
              <div class="col-sm-4">
                <div v-for="i in 2" :key="i + 'img'" class="form-group">
                  <label :for="'img' + i">輸入圖片網址<i class="asterisk text-danger ml-1">*</i></label>
              ...
              <div class="col-sm-8">
                <div class="form-group">
                  <validation-provider rules="required" v-slot="{ errors, classes, passed }">
                    <label for="title" :class="classes">產品名稱<i class="asterisk text-danger ml-1">*</i></label>
                ...
                <div class="form-group">
                  <label for="content">產品說明<i class="asterisk text-danger ml-1">*</i></label>
